          ...
          fetch(evolutionURL)
            ...
            .then((data) => {
              ...
              if (evolutionLength === 0) {
                ...
                if (
                  pokeName === dataArray.species.name &&
                  dataArray.evolves_to[0] !== undefined
                ) {
                  pokemon1 = pokeName;
                  ...
                  pokeName === dataArray.evolves_to[0].species.name &&
                  dataArray.evolves_to[0] !== undefined
                ) {
                  pokemon2 = pokeName;
                  ...
                  if (dataArray.evolves_to[0].evolves_to[0] !== undefined) {
                    pokemon3 =
                      dataArray.evolves_to[0].evolves_to[0].species.name;
                    evolutionLineArray.push(pokemon3);
                  }
                  evolutionLineSprites = getSprites(evolutionLineArray);
                  console.log(evolutionLineArray);
