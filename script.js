...
fetch(API).then(res => res.json()).then(data => {
    console.log(data);
    let pokeURL = data['pokemon-species'];
    //let pokeName = 'bulbasaur';
   // pokeToFetch = pokeURL + pokeName;
    let evolutionChain = 'evolution-chain/';
    let evolutionURL = API + evolutionChain;
    fetch(evolutionURL).then(res => res.json()).then(data=> console.log(data));
    fetch(pokeURL).then(res => res.json()).then(data => console.log(data));
})
*/
